...
var _user$project$Resource$loaded = function (resource) {
	var _p0 = resource;
	if (_p0.ctor === 'Loaded') {
		return _elm_lang$core$Maybe$Just(_p0._0);
	} else {
...
var _user$project$Resource$Error = function (a) {
	return {ctor: 'Error', _0: a};
};
var _user$project$Resource$Loaded = function (a) {
	return {ctor: 'Loaded', _0: a};
};
var _user$project$Resource$Loading = {ctor: 'Loading'};
var _user$project$Resource$NotFetched = {ctor: 'NotFetched'};
var _user$project$Resource$map = F2(
	function (fn, resource) {
		var _p1 = resource;
		switch (_p1.ctor) {
			case 'Loaded':
				return _user$project$Resource$Loaded(
					fn(_p1._0));
			case 'NotFetched':
				return _user$project$Resource$NotFetched;
			case 'Loading':
				return _user$project$Resource$Loading;
			default:
				return _user$project$Resource$Error(_p1._0);
		}
	});
...
var _user$project$Question$NodToQuestionRequest = function (a) {
	return {question: a};
};
var _user$project$Question$QuestionAskedResponse = F2(
	function (a, b) {
		return {error: a, question: b};
	});
var _user$project$Question$questionAskedResponse = A3(
	_elm_lang$core$Json_Decode$map2,
	...
	A2(
		_elm_lang$core$Json_Decode$field,
		'question',
		_elm_lang$core$Json_Decode$maybe(_user$project$Question$question)));
var _user$project$Question$ask = F2(
	function (presentationID, questionText) {
		...
		var url = A2(
			_elm_lang$core$Basics_ops['++'],
			'http://',
			A2(_elm_lang$core$Basics_ops['++'], _user$project$Config$apiServerAddress, '/api/questions/ask'));
		return A3(_elm_lang$http$Http$post, url, body, _user$project$Question$questionAskedResponse);
	});
var _user$project$Question$questionUpdateResponse = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Question$QuestionAskedResponse,
	A2(
		_elm_lang$core$Json_Decode$field,
	...
	A2(
		...
		'question',
		_elm_lang$core$Json_Decode$maybe(_user$project$Question$question)));
var _user$project$Question$nod = function (question) {
	var body = _elm_lang$http$Http$jsonBody(
		_user$project$Question$nodToQuestionRequest(
	...
	return _elm_lang$http$Http$request(
		{
			...
			headers: {ctor: '[]'},
			body: body,
			expect: _elm_lang$http$Http$expectJson(_user$project$Question$questionUpdateResponse),
			timeout: _elm_lang$core$Maybe$Nothing,
			withCredentials: false
		});
};
var _user$project$Question$QuestionUpdateResponse = F2(
	function (a, b) {
		return {error: a, question: b};
	});
...
var _user$project$Mode_Audience$viewAskQuestion = function (model) {
	var highRange = A2(_elm_lang$core$List$range, 74, 101);
	var medHighRange = A2(_elm_lang$core$List$range, 50, 74);
	var lowMedRange = A2(_elm_lang$core$List$range, 25, 49);
	var lowRange = A2(_elm_lang$core$List$range, 1, 24);
	var charactersUsed = _elm_lang$core$String$length(model.question);
	var limitPercentUsed = _elm_lang$core$Basics$ceiling(
		A2(
			F2(
				function (x, y) {
					return x * y;
			...
			100.0,
			function (x) {
				return x / _user$project$Mode_Audience$constMaxQuestionLength;
			}(
				...
				},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$Mode_Audience$QuestionTextReceived),
								_1: {
									ctor: '::',
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class(countColor),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(
												A2(
													_elm_lang$core$Basics_ops['++'],
													_elm_lang$core$Basics$toString(charactersUsed),
													A2(
														_elm_lang$core$Basics_ops['++'],
														' / ',
														_elm_lang$core$Basics$toString(_user$project$Mode_Audience$constMaxQuestionLength)))),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
							...
							_0: A2(
								_elm_lang$html$Html$a,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Mode_Audience$QuestionAsked),
											_1: {ctor: '[]'}
										}
									}
								},
...
var _user$project$Mode_Audience$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$Mode_Landing$Model = F5(
	function (a, b, c, d, e) {
		return {presentationToJoin: a, username: b, password: c, passwordRepeat: d, authMode: e};
	});
var _user$project$Mode_Landing$RegisterAction = {ctor: 'RegisterAction'};
var _user$project$Mode_Landing$LoginAction = {ctor: 'LoginAction'};
var _user$project$Mode_Landing$NoneSelected = {ctor: 'NoneSelected'};
var _user$project$Mode_Landing$init = function () {
	var model = {presentationToJoin: '', username: '', password: '', passwordRepeat: '', authMode: _user$project$Mode_Landing$NoneSelected};
	return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
}();
...
var _user$project$Mode_Landing$AuthActionSelected = function (a) {
	return {ctor: 'AuthActionSelected', _0: a};
};
...
var _user$project$Mode_Landing$viewLoginForm = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
					...
					_0: A2(
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Mode_Landing$UsernameInput),
									_1: {ctor: '[]'}
								}
							}
						},
						...
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_user$project$Mode_Landing$PasswordInput),
										_1: {ctor: '[]'}
									}
								}
							},
...
var _user$project$Mode_Landing$viewRegisterForm = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
							...
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Mode_Landing$PasswordRepeatInput),
											_1: {ctor: '[]'}
										}
									}
								},
	...
	var _p1 = function () {
		...
		switch (_p2.ctor) {
							...
							_elm_lang$html$Html$a,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Mode_Landing$AuthActionSelected(_user$project$Mode_Landing$LoginAction)),
										_1: {ctor: '[]'}
									}
								}
							},
								...
								_elm_lang$html$Html$a,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Mode_Landing$AuthActionSelected(_user$project$Mode_Landing$RegisterAction)),
											_1: {ctor: '[]'}
										}
									}
								},
			...
			case 'LoginAction':
				return {
					ctor: '_Tuple2',
					_0: _user$project$Mode_Landing$viewLoginForm,
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$a,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Mode_Landing$Login(
								...
								_elm_lang$html$Html$a,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Mode_Landing$AuthActionSelected(_user$project$Mode_Landing$NoneSelected)),
											_1: {ctor: '[]'}
										}
									}
								},
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: _user$project$Mode_Landing$viewRegisterForm,
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$a,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Mode_Landing$Register(
												{username: model.username, password: model.password, passwordRepeat: model.passwordRepeat})),
										_1: {ctor: '[]'}
									}
								}
							},
...
var _user$project$Mode_Presenter$viewQuestion = function (question) {
	...
	var nodMsg = A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			' ',
			A2(_elm_lang$core$Basics_ops['++'], people, ' nodded to this')));
	return A2(
		_elm_lang$html$Html$tr,
		{
			ctor: '::',
			...
			if (_p7.ctor === 'Loaded') {
				...
				return {
					...
					_2: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Loading questions...'),
							_1: {ctor: '[]'}
						})
				};
			}
							...
							_0: A2(
								_elm_lang$html$Html$a,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Mode_Presenter$HideQuestions),
											_1: {ctor: '[]'}
										}
									}
								},
...
var _user$project$Mode_Presenter$viewCreatePresentationButton = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('action-button'),
		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('fas fa-plus'),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {ctor: '[]'}
...
var _user$project$Mode_Presenter$viewCreatePresentation = function (model) {
	return model.showPresentationForm ? A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('content card'),
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(numQuestionsInfo),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
	...
	function (msg, model) {
		...
		do {
			switch (_p4._0.ctor) {
				...
				case 'PresenterModeMsg':
					if (_p4._1.ctor === 'Presenter') {
						var _p10 = A2(_user$project$Mode_Presenter$update, _p4._0._0, _p4._1._0);
						var newPresModel = _p10._0;
						var presCmd = _p10._1;
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									mode: _user$project$Main$Presenter(newPresModel)
								}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$PresenterModeMsg, presCmd)
						};
					} else {
		...
		var _p11 = A2(_elm_lang$core$Debug$log, 'Model is ', model);
		var _p12 = A2(_elm_lang$core$Debug$log, 'Got message ', msg);
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
